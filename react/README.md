Загрузил домашнее задание по пятой лекции в -> "hometask-6" (cделал контроллируемый <textarea> в компоненте "SecondTask", выключил остальные логи в консоли, чтобы не мешались, передачу функции осуществил в предыдущих домашних работах)

--------------

Загрузил домашнее задание по пятой лекции в -> "hometask-5" (переделал карточки "Artist" в классовые компоненты, создал несколько дополнительных компонентов с событиями onKeyDown, onSubmit, onClick, onMouseEnter и onScroll )
