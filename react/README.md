Поправил домашнее задание по третьей лекции в   -> "hometask-3" (добавил в классовый компонент "LogInClass" constructor и super(props), исправил ошибки в названии компонентов LoggedInTrue и LoggedInFalse, поправил их условный рендеринг в компоненте LogInClass )
